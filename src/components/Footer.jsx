                ...
                <div className="grid grid-cols-[1.5fr_3fr] gap-24 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-2.5 mb-6">
                            <a href="https://instaflow-1-8a6r.onrender.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] flex items-center justify-center hover:-translate-y-1 transition-transform">
                            ...
                            <a href="https://whatsapp-automation-swart.vercel.app/login" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-[#087E07] flex items-center justify-center hover:-translate-y-1 transition-transform">
